 ...
 * assertions about the result. Note the use of the @AutoConfigureMockMvc
 * together with @SpringBootTest to inject a MockMvc instance. Having
 ...
 * layers of the context using the @WebMvcTest. Spring Boot automatically tries
 * to locate the main application class of your application in either case, but
 * you can override it, or narrow it down, if you want to build something
 * different.
 */
